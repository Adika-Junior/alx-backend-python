...
# Comma-separated list of hosts, e.g. "localhost,127.0.0.1,example.com"
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('MYSQL_DB', os.environ.get('MYSQL_DATABASE', 'messaging_app')),
...
# Password validation
# https://docs.djangoproject.com/en/4.2/ref/settings/#ref/settings/auth-password-validators
